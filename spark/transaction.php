...
<head>
  ...
  background-image: -webkit-linear-gradient(70deg, #A3D8F4 50%, #E4E9FD 50%);
  min-height:1000px;
      }
    </style>
</head>
            ...
            <div class="row">
                ...
                ?>
                    <tr>
                        ...
                        <td style="text-align:center;"><a href="customerdetails.php?id= <?php echo $rows['id'] ;?>"> <button type="button" class="btn">Transfer Money/Show Details</button></a></td> 
                    </tr>
                <?php
                    }
                ?>
